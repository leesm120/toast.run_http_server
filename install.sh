...
wget https://nodejs.org/dist/latest-v10.x/node-v10.20.1-linux-x64.tar.xz
tar xf node-v10.20.1-linux-x64.tar.xz

export PATH=./node-v10.20.1-linux-x64/bin/:$PATH
